        ...
        >
            <HStack maxW={"1080px"}>
                <VStack align={"start"} spacing={8}>
                    ...
                    <Text color={"#E7E4D8"} fontSize={14}>
                        Eneas es el contrato de arrendamiento que hasta un
                        cavernícola puede configurar de forma sencilla,
                        profesional y segura. Déjate llevar por nuestra potente
                        tecnología y da forma a tu contrato ideal para arrendar
                        fincas habitacionales, comerciales, industriales o
                        rústicas. Recuerda, basta con que respondas unas cuantas
                        ...
                        regulaciones federales y estatales que a tu caso le sean
                        aplicables.
                    </Text>
                    <VStack align={"start"}>
